...
function DownButton(x, y, width, height, handler, bet_amount) {
  ButtonObject.apply(this, arguments);
  this.bet_amount = bet_amount;
  this.handleClick = function(mouse) {
...
var down_bet_amount = function(bet_amount) {
...
var button_object_array = [
  ...
  new ButtonObject(436, 636, 97, 92,spin_handler),
  new BetButton(198, 628, 192, 46, change_bet_amount, 9),
  ...
  new CloseButton(551, 636, 97, 92), //close
  new DownButton(198, 695, 192, 46, down_bet_amount, 9), //-100 bet
  ];
...
var render = function () {
  ...
  // draw bg img
  ctx.drawImage(bg_img, 0, 0, 800, 800, 0, 0, 800, 800);
 ...
 // ctx.fillText(game_state.win, 265, 358);
  ctx.fillText("Winnings " + game_state.paid+"$", 385, 367);
  ...
  // draw game state highlight tiles
	...
	ctx.textAlign = "right";
	ctx.textBaseline = "top";
	  ctx.fillText("Free spins " +freespins, 395, 367);
  ctx.fillText("Winnings " + game_state.paid+"$", 625, 367);
  }
