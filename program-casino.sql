...
INSERT INTO `items` (`name`, `label`, `limit`) VALUES  
    ...
    ('vodkafruit', 'Fruit vodka', 5),
    ('rhumfruit', 'Fruit rum', 5),
    ('teqpaf', "Teq'paf", 5),
    ('rhumcoca', 'Rum-cola', 5),
    ('mojito', 'Mojito', 5),
    ('ice', 'Lód', 5),
